...
char *cmdstr[] = {"fork", "Setpid", "currpid",  "wait", "exit", "sleep", "wakeup", "ps",   "schedule", "timer", "help", "quit","setnice"};
...
int executeCmd(char** params, int nparams)
{
    ...
    case TIMER:
        ...
        break;
	case NICE:
		set_nice(atoi(params[1]),atoi(params[2]));
		break;
    case HELP:
        printf("Commands: fork, wait, exit, ps, Setpid, currpid, sleep, wakeup, timer, help, setnice, setweight\n");
        break;
    case QUIT:
        rc = 0;
        break;
